...
\begin{figure*}[!t]
\centering
\subfloat[Case I]{\includegraphics[width=1.25in]{}
\label{fig_first_case}}
\hfil
\subfloat[Case II]{\includegraphics[width=1.25in]{}
\label{fig_second_case}}
...
\begin{figure} 
    \centering
  \subfloat[a\label{1a}]{%
       \includegraphics[width=0.45\linewidth]{fig/extension.eps}}
    \hfill
  \subfloat[b\label{1b}]{%
        \includegraphics[width=0.45\linewidth]{fig/bbox.eps}}
...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[height=0.7\textwidth]{fig/800_mono.eps}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{.24\textwidth}
    \centering
    \includegraphics[height=0.7\textwidth]{fig/1775_mono.eps}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{.15\textwidth}
        \centering
        \includegraphics[width=0.8\textwidth]{fig/lines.eps}
        \caption{}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{.15\textwidth}
        \centering
        \includegraphics[width=0.8\textwidth]{fig/candidate2.eps}
        \caption{}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{.15\textwidth}
        \centering
        \includegraphics[width=0.8\textwidth]{fig/candidate3.eps}
        \caption{}
    \end{subfigure}
    \hfill
    \caption{Three types of Candidates}
\end{figure}
...
\begin{algorithm}[H]
    \begin{algorithmic}[1]
        \State $n=0$
        \For {$segmentation$, $view$ in $all\_views$}
        \State $box=Regenerating(candidate, view)$
        \If{$box$ in $FOV(view)$ and $box$ is not at $Edge(view)$}
        \If{$overlapRatio(box,segmentation)> threshold$}
        \State $n++$
        \EndIf
        \EndIf
        \EndFor
    \end{algorithmic}
    \caption{Counter}\label{alg:counter}
\end{algorithm}
