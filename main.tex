...
Pedestrians' appearance varies because of the change of height, pose, sex, cloth and accessory.
...
\begin{figure}[!t]
\centering
\includegraphics[width=2.5in]{fig/extension2.eps}
\label{fig_first_case}
...
\begin{figure} 
    \centering
  \subfloat[a\label{1a}]{%
       \includegraphics[width=0.3\linewidth]{fig/lines.eps}}s
    \hfill
  \subfloat[b\label{1b}]{%
...
$$
Where n stands for the number of cameras who detect a same pedestrian by a monocular detector. Monocular detectors sometimes fail to accurately locate the bounding boxes in images. Therefore, n is counted by the number of valid re-projected bounding boxes for a candidate in the top view. A valid bonding box should be in its corresponding camera's field of view.
